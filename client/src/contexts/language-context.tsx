...
const translations = {
  en: {
    ...
    'dashboard.subtitle': 'Live monitoring and analytics for election results and complaints',
    ...
    'complaints.subtitle': 'Monitor and manage election-related complaints and irregularities',
    ...
    'mec.subtitle': 'Record and manage results received from Malawi Electoral Commission (MEC)',
    ...
    'comparison.subtitle': 'Compare internal results with official MEC results to identify discrepancies',
  ...
  ny: { // Chichewa translations
    ...
    'nav.user_management': 'Kasamalidwe ka Ogwiritsa',
    'nav.political_parties': 'Zipani za Ndale',
    'nav.data_management': 'Kasamalidwe ka Zidziwa',
    'nav.admin_management': 'Kasamalidwe ka Admin',
    'nav.audit_trail': 'Kusanthula',
    'nav.profile': 'Mbiri yanu',
    
    // Dashboard
    'dashboard.title': 'Malo a Chisankho Chandalama',
    'dashboard.subtitle': 'Kuyang\'anira ndi kusanthula kwa zotsatira za chisankho ndi madandaulo',
    ...
    'complaints.subtitle': 'Yang\'anitsani ndi kasamalidwe ka madandaulo okhudzana ndi chisankho ndi zosayenera',
    ...
    'mec.subtitle': 'Lembani ndi kasamalidwe ka zotsatira zolandira kuchokera ku Malawi Electoral Commission (MEC)',
    ...
    'comparison.subtitle': 'Fananizirani zotsatira zamkati ndi zotsatira zovomerezeka za MEC kuti muzindikire kusiyana',
